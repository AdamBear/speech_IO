if(!window.TranslateSelectionIsActive){
    ...
    //    function(details){
    //        if(detail.message.method === 'prepareBalloon'){
    //            balloon = createBalloon('...');
    //            balloon.placeTop();
    //            sendResponse({});
    //            
    //        }
    //        if(detail.message.method === 'setText'){
    //            balloon.setText(detail.message.string);
    //            balloon.placeTop();
    //            sendResponse({});
    //        }
    //    }
	...
	chrome.extension.onMessage.addListener(
		function (req, sender,sendResponse) {
			...
			if(req.method == 'prepareBalloon') {
				balloon = createBalloon('...');
				balloon.placeTop();
                var str = window.getSelection().anchorNode.data.toString().trim();
                console.log(str);
				sendResponse({msg:'...',sentence:str});
			}
			if(req.method == 'showResult') {
				balloon.setText(req.resstr);
				balloon.placeTop();
